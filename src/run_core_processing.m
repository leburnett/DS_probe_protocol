...
date_to_process = '08_06_2024';
cell_type = 'Cm10';

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 

%% Path to cell type folder
protocol_folder = 'O:\Burnett\Jinyong\DS_probe_protocol_1REP_RightHemi_20Hz_05-22-24_09-09-09\';
project_folder = strcat(protocol_folder, date_to_process);
cd(project_folder)
...
if n_subfolders ==0 
    date_folder = date_to_process;
    process_ds_probe_protocol_data(project_folder, date_folder, date_to_process, cell_type)
...
elseif n_subfolders > 0 
    ...
    for idx = 1:n_subfolders
        ...
        subfolder = strcat(date_to_process, '/', subfolder_str);
